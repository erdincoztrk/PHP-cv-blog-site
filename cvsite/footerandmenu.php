									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li><a href="solutions/index?solution"><?php echo "Bütün Çözümler($cozumsayi)"; ?></a></li>
												<?php while($diller = $dillistele -> fetch(PDO::FETCH_ASSOC)){ ?>
												<li><a href="solutions/index?solution=<?php echo $diller['dil_ad'] ?>"><?php echo $diller['dil_ad']."(".$diller['dil_sayi'].")" ?></a></li>
											<?php } ?>
